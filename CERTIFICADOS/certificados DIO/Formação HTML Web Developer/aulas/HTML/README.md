# 📘 Formação HTML Web Developer – Projetos Básicos

Este repositório contém projetos desenvolvidos durante meus estudos em **HTML**, com foco na aprendizagem da estrutura básica, uso de tags, atributos e organização de conteúdo em páginas web, sem utilização de CSS ou JavaScript.

Os projetos foram criados como parte da **Formação HTML Web Developer**, com o objetivo de praticar os conceitos fundamentais do HTML.
...
### 🟢 05 – Listas Ordenadas e Não Ordenadas
**Descrição:**  
...
## 🎯 Objetivo
Praticar os conceitos fundamentais do HTML e criar uma base sólida para estudos futuros em CSS, JavaScript e desenvolvimento web.
